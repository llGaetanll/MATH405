...
\begin{document}
  \footnotesize
    ...
    Here, $T$ behaves just like a function, which means that it {\it must} use
    all of $T$, but it {\it does not} have to use all of $W$. For example, the
    following is a perfectly valid transformation.
  ...
  \TODO{} Missing first 10 minutes of class (sorry)
  ...
  \note{
    ...
    Linear Transformations don't commute nicely like that.

    \TODO{} check that statement above.
  }
